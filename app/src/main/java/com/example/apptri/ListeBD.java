...
public class ListeBD extends SQLiteOpenHelper {
    ...
    public final String SQL_INSERT = "INSERT INTO Liste VALUES(1,'Déchets alimentaires','Compost – Retour à la terre : la matière organique est transformée en terreau riche qui sera utilisé pour amender les sols. Pour cela, Il est primordial que les déchets organiques soient bien triés et ne contiennent aucun débris de plastique ou métal ou autre (épluchures de fruits et légumes, filtre et marc de café..)');";
